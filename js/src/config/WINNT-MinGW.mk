...
# Slightly tidied up 29-Sep-2020
#
...
OS_CFLAGS = -D_X86_=1 -DXP_WIN -DXP_WIN32 -DWIN32 -D_WINDOWS -D_WIN32 -DWINVER=$(OS_WINVER) -D_WIN32_WINNT=$(OS_WINVER) -D_MINGW -DEXPORT_JS_API
